return {
	...
	config = function()
		...
		-- 	builtin.live_grep({ search_dirs = { "app/", "spec/" } })
		-- end, { desc = "Find text in backend files" })
		-- keymap.set("n", "<leader>fgf", function()
		-- 	builtin.live_grep({ search_dirs = { "front-end/" } })
		-- end, { desc = "Find text in frontend files" })
